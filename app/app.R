...
ui <- dashboardPage(skin = "black",title="MARTINI Status Assessment",
              ...
              dashboardSidebar(sidebarMenu(id="tabs",
                    ...
                    menuItem("About", tabName = "about", icon = icon("book"), selected =T)#,
              ), 
              collapsed=F),
                  ...
                  tabItem(tabName = "MapX",
                      ...
                      tabItem(tabName = "about",
                              fluidRow( column(6,
                                               ...
                                               h4("Results"),
                                               p("This app is written in the R statistical programming language, using the 'Shiny' package. Results from the Oslofjord biogeochemical model results (OF800 Hindcast Archive 2017-2019) are used, showing spatial variation of ecologically relevant indicator parameters, representing both biological quality elements (phytoplankton, and macroalgae) and supporting physico-chemical indicators (Secchi depth, bottom oxygen and nutrient concentrations)."),
