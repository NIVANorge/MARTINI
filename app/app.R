      ...
      target="_blank")
        ...
        em("Revisjon av kystvannsdelen av veileder 02:2018. NIVA-rapport 7856-2023.")),
                      ...
                      tabItem(tabName = "about",
                              fluidRow( column(6,
                                               h3("About this app"),
                                               p("The work to develop this app began as part of the MARTINI project ('MARTINI - Understanding and predicting water quality for ecosystem-based management of Norwegian fjords, coastal waters and seas'), funded by the Norwegian Research Council (Forskningsrådet) under the MARINFORSK program (Marine Resources and Environent)."),
                                               ...
                                               p("Further developments were made as part of the Norwegian Research Council project MAREA project (MARine Ecosystem Accounting for integrated coastal planning in the Oslofjord):"),
                                               p(a(href="https://prosjektbanken.forskningsradet.no/project/FORISS/326976", "https://prosjektbanken.forskningsradet.no/project/FORISS/326976",target="_blank")),
                                               p("and subsequently as part of the FoU project OSLOMOD ‘Modelling av Oslofjorden’, funded by the Norwegian Environment Agency (Miljødirektoratet), Viken county council (now Akershus, Buskerud og Østfold county council), and Fagrådet for indre Oslofjord."),
                                               p("The findings of the OSLOMOD project were published in the following report:"),
                                               p(a(href="https://www.miljodirektoratet.no/publikasjoner/2026/april-2026/modellering-av-oslofjorden-scenarier-med-redusert-menneskelig-belastning-for-a-oppna-god-okologisk-tilstand/", "https://www.miljodirektoratet.no/publikasjoner/2026/april-2026/modellering-av-oslofjorden-scenarier-med-redusert-menneskelig-belastning-for-a-oppna-god-okologisk-tilstand/",target="_blank")),                                               
                                               p("This app is written in the R statistical programming language, using the 'Shiny' package. Results from the OF800 and NIVA Fjord physical-biogeochemical models and a statistical model for the lower growth limit of macroalgae (MSMDI index) are used, showing spatial variation of ecologically relevant indicator parameters, representing both biological quality elements (phytoplankton and macroalgae) and supporting physico-chemical indicators (Secchi depth, bottom oxygen and nutrients)."),
                                               p("Following the Water Framework Directive principles, the app aggregates estimated values of individual indicators to arrive at an overall ecological status in a selected waterbody. The user can investigate the spatial variation of the indicator parameters as well as the resulting ecological status in coastal water bodies, expressed as an ecological quality ratio (EQR) determined by comparing simulated values of indicator parameters with official threshold values used to classify status of water bodies."),
                                               p("The app includes results of simulations under different scenarios of load reductions for nutrients, particles, and organic matter. This allows users to examine resulting changes in estimated indicator parameters under these scenarios and in the predicted ecological status."),
                                               p("For more details please refer to the above report.")
                              )))                      
                      )))
